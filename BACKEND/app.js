...
// //import fs from 'fs'
// //fs.writeFileSync("index.html","hiiii")


// //let data= fs.readFileSync("index.txt")
// //console.log(data.toString(),"heheheheheheh")
...
// //     })
// //     server.listen(3000,()=>{
// //         console.log("sever runnninggggg")
// //     })
...
// //     console.log("mai hun kon...")
// //     next()
// // })
// // app.use((req,res,next)=>{
// //     console.log("mai na jaan deu bhai rr..")
// // })
...
app.post("/signup",async(req,res)=>{
   ...
   console.log(findData,"hejwdbhbdhs")

   if (findData){
      return res.send("user zindaa h ")
   }
   else{
      let updatedP = await bcryptjs.hash (passWord,10)
      console.log(updatedP,"dekhooo")
...
let auth=(req,res,next)=>{
   ...
   console.log(token,"token h ji")
   if(!token){
      return res.send("kaun h ye log")
   }
